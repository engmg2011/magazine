...
function setShare(){ 
    $('#buttons-expanded').html('<div class="inner" style="display: none;"></div>\
        <ul class="shareIcons">\
            ...
            <li><a href="http://www.addthis.com/bookmark.php?v=300&winname=addthis&pub=ra-576e6c930a82265e&source=msd-1.0&lng=ar-aa&s=whatsapp&url='+encodeURIComponent(window.sharing.link)+'&ate=AT-ra-576e6c930a82265e/-/-/57dea87bc13dddd0/4&frommenu=1&uud=1&ct=1&tt=0&captcha_provider=recaptcha2&pro=0"  class="ui-link"><img src="images/whatsapp.png" alt="" style="width: 16px; height: 16px; margin-top: 8px;"></a></li>\
